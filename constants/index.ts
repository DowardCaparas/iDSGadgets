...
export const navLinks = [
    {url: '#home', label: 'Home' , imgICON: '/home.svg'},
    {url: '#products', label: 'Products', imgICON: '/box.svg'},
    {url: '#about', label: 'About Us', imgICON: '/info.svg'},
    {url: '#blog', label: 'Blog', imgICON: '/newspaper.svg'},
    {url: '#contact', label: 'Contact Us', imgICON: '/phone.svg'},
];
