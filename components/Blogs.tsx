...
const Blogs = () => {
  ...
  return (
    <div className='w-full container__padding' id='blog'>
       <h3 className='text-slate-500 font-semibold'>Latest News & Blogs</h3>

        <div className='grid md:grid-cols-3 grid-flow-row gap-4 grid-cols-2 mt-6'>

          {blogs.map((item, index) => (
            <div key={index} className='flex flex-col border border-slate-200 
        ...
        <div className='bg-zinc-950 py-20 mt-28 flex flex-col justify-center 
        items-center gap-10 container__padding rounded-md'>
