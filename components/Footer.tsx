...
const Footer = () => {
  return <>
   ...
   {/*Footer Left */}
    <div className="flex flex-col justify-start items-start gap-6 lg:w-1/3">
      ...
      <p className="text-primary_gray">
        Elevate your tech game with top-tier gadgets, where innovation meets quality.
      </p>
   ...
   <div className="bg-primary_black flex items-center justify-center py-6 
   border-t-2 border-secondary_gray">
    <p className="text-secondary_gray max-sm:text-sm">Copyright By Doward Caparas &copy; 2024 All Rights Reserved</p>
   </div>
  </>;
};
